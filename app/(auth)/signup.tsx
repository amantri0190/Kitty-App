...
// import { googleSignIn, isValidIndianMobile } from "@/lib/google";
...
// <Text className="mb-2 text-3xl font-bold text-black">Create account</Text>

// <Text className="mb-8 text-gray-500">Sign up to get started</Text>

//       <View className="flex-row items-center px-4 py-3 mb-2 border border-gray-300 rounded-xl">
//         <Text className="mr-2 text-lg">+91</Text>
//         <TextInput
...
//         disabled={loading}
//         className="items-center justify-center border border-gray-300 h-14 rounded-xl"
//       >
...
//     // ← ADD THIS: Log the user in first!
//     await login(res.userId, res.hasUsername);

//     // Then navigate based on hasUsername
...
//       {/* CONTENT CARD */}
//       <View className="flex-1 bg-[#FFFDF8] rounded-t-[32px] -mt-16 px-6 pt-8 shadow-2xl">
//         {/* Title */}
//         <Text className="text-[28px] font-bold text-[#1F1F1F] mb-1 tracking-tight">
//           Create account
//         </Text>
...
export default function SignupScreen() {
  ...
  return (
    <View className="flex-1 bg-[#F5F3EE]">
      ...
      {/* CONTENT CARD */}
      <View className="flex-1 bg-[#FFFDF8] rounded-t-[32px] -mt-20 px-6 pt-8 shadow-2xl">
        {/* Title */}
        <Text className="text-[26px] font-bold text-[#1F1F1F] mb-0.5 tracking-tight">
          Create Account
        </Text>
